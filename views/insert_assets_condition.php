...
$asset_types_query = "SELECT asset_type, quantity FROM assets";
$asset_types_result = mysqli_query($conn, $asset_types_query);
if (!$asset_types_result) {
...
// Check if there are any available asset types
        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <?php if (empty($available_asset_types)): ?>
                        <div class="alert alert-info">
                            There are currently no asset types available for assignment. All assets have reached their maximum quantity across locations.
                        </div>
                    <?php else: ?>
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="asset_type" name="asset_type" required>
                                    ...
                                    <?php foreach ($available_asset_types as $type): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="serial_no" name="serial_no" required minlength="5" maxlength="20">
                            </div>
                            <div class="mb-3">
